...
class OrdersApi {
    ...
    async updateBillingAddress(id, body) {
        return await request(`${config.serverAPIurl}/${this.pathName}/${id}/billing_address`, `PUT`, body);
    }

    async updateShippingAddress(id, body) {
        return await request(`${config.serverAPIurl}/${this.pathName}/${id}/shipping_address`, `PUT`, body);
    }
    ...
    async updateItem(id, itemId, body) {
        return await request(`${config.serverAPIurl}/${this.pathName}/${id}/items/${itemId}`, 'PUT', body);
    }
    ...
    async addTransaction(id, body) {
        return await request(`${config.serverAPIurl}/${this.pathName}/${id}/transactions`, 'POST', body);
    }

    async updateTransaction(id, transactionId, body) {
        return await request(`${config.serverAPIurl}/${this.pathName}/${id}/transactions/${transactionId}`, 'PUT', body);
    }

    async deleteTransaction(id, transactionId) {
        return await request(`${config.serverAPIurl}/${this.pathName}/${id}/transactions/${transactionId}`, 'DELETE');
    }
    ...
    async updateDiscount(id, discountId, body) {
        return await request(`${config.serverAPIurl}/${this.pathName}/${id}/discounts/${discountId}`, 'PUT', body);
    }

    async deleteDiscount(id, discountId) {
        return await request(`${config.serverAPIurl}/${this.pathName}/${id}/discounts/${discountId}`, 'DELETE');
    }
