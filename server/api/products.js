...
class ProductsApi {
  ...
  async addProductImages(id, body) {
    return await request(
      `${config.serverAPIurl}/${this.pathName}/${id}/images`,
      `POST`,
      body,
      {},
      'multipart/form-data',
  ...
  async updateProductImages(id, image, body) {
    return await request(
      `${config.serverAPIurl}/${this.pathName}/${id}/images/${image}`,
      `PUT`,
      body,
    );
  }
  ...
  async addProductFiles(id, body) {
    return await request(
      `${config.serverAPIurl}/${this.pathName}/${id}/files`,
      `POST`,
      body,
      {},
      'multipart/form-data',
  ...
  async updateProductShop(id, shop, body) {
    return await request(
      `${config.serverAPIurl}/${this.pathName}/${id}/shops/${shop}`,
      `PUT`,
      body,
    );
  }
  ...
  async updateProductOption(id, optionId, body) {
    return await request(
      `${config.serverAPIurl}/${this.pathName}/${id}/options/${optionId}`,
      'PUT',
      body,
    );
  }
  ...
  async getProductValues(id, optionId) {
    return await request(
      `${config.serverAPIurl}/${this.pathName}/${id}/options/${optionId}/values`,
    );
  }
  ...
  async getProductValueById(id, optionId, valueId) {
    return await request(
      `${config.serverAPIurl}/${this.pathName}/${id}/options/${optionId}/values/${valueId}`,
    );
  }
  ...
  async updateProductVariant(id, variantId, body) {
    return await request(
      `${config.serverAPIurl}/${this.pathName}/${id}/variants/${variantId}`,
      'PUT',
      body,
    );
  }
  ...
  async setVariantOptions(id, variantId, body) {
    return await request(
      `${config.serverAPIurl}/${this.pathName}/${id}/variants/${variantId}/options`,
      'PUT',
      body,
    );
  }
