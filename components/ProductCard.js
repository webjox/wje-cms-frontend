      ...
      <div className={styles.productWrapper}>
        <div className={styles.imgWrapper}>
          ...
          <div
            ...
            style={inFeatured ? { backgroundColor: 'red' } : {}}>
        ...
        <div
          ...
          style={stock ? { background: '#fff' } : {}}>
          <p className={styles.totalPrice}>
            {product.stock_price * quantity} <span>₽</span>
          </p>
          <p className={styles.priceInfo}>
            цена склада, <span>{countQuantity(false)}</span>
          </p>
        </div>
        <div
          onClick={() => {
          ...
          className={`${styles.price} ${styles.priceB}`}
          style={stock ? {} : { background: '#fff' }}>
          <p className={styles.totalPrice}>
            {product.price * quantity} <span>₽</span>
          </p>
          <p className={styles.priceInfo}>
            цена магазинов, <span>{countQuantity(true)}</span>
          </p>
        </div>
