            ...
            <div className={styles.wrapper}>
                ...
                >
                    ...
                    <div className={styles.container}>
                        <div onClick={handlerFeatured} className={styles.favorite} style={inFeatured ? {backgroundImage:'url(/wishlist.svg)', backgroundColor: 'red'} : {backgroundImage:'url(/wishlist.svg)'}}/>
                    </div>
                    ...
                    <Link href={`/product/${product.slug}`}>
                        <a>
                            <div className={styles.container}>
                                ...
                                <div className={styles.toView} style={{backgroundImage:'url(/toView.svg)'}}>
                    ...
                    <button onClick={inBasket ? ()=>{} : handlerAddToCart} className={styles.addToBasket} style={inBasket ? {background:'rgb(143 232 202)'} : {}}>
                            <p>
