        ...
        <Main> 
            ...
            <div className={styles.dataContainer}>
                <div className={styles.personalData}>
                    ...
                    <span className={styles.infoRow}>Дата регистрации: <span style={{color: '#1d1d1d'}}>{userData.createdAt}</span> </span>
                    <span className={styles.infoRow}>Имя: <span style={{color: '#1d1d1d'}}>{userData.first_name}</span> </span>
                    <span className={styles.infoRow}>Фамилия: <span style={{color: '#1d1d1d'}}>{userData.last_name}</span> </span>
                    <span className={styles.infoRow}>Email: <span style={{color: '#1d1d1d'}}>{userData.email}</span> </span>
                </div>
