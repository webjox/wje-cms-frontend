...
const Description = ({children}) => {
    ...
    return (
        <div>
            <div className={styles.descriptionContent} style={dropped ? {maxHeight: "82px"} : {maxHeight:height}}>{children}</div>
            <div className={styles.descriptionBtn} onClick={() => {setDropped(!dropped)}}>{dropped ? `Показать полностью` : `Скрыть описание`}</div>
        </div>
    )
};
                ...
                <NavBar/>
                    ...
                    <div className={styles.main}>
                        ...
                        <div className={styles.breadcrumbs}>
                            ...
                            {` > `}
                            <Link href={`/category/${category._id}`}><a>
                                {category.name}
                            </a></Link>
                            {` > `}
                        ...
                        <div className={styles.contentWrapper}>
                            ...
                            <div className={styles.description}>
                                <h1>Описание</h1>
                                {product.description.length > 400 ? <Description><Content/></Description> : <div className={styles.descriptionContent}><Content/></div>}
                            </div>       

                            {files.length ? <div className={styles.docsWrapper}>
                        ...
                        <div className={styles.productCardWrapper}>
                            ...
                            {products.length ?  <div className={styles.relatedWrapper}>
