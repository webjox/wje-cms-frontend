            ...
            <div className={styles.form}>
              ...
              <div className={styles.persData}>
                <Tooltip
                  open={persValid}
                  disableHoverListener
                  title="Поставьте, пожалуйста, чекбокс">
                  <input
                    className={styles.check}
                    value={pers}
                    onChange={persHandler}
                    name="persData"
                    type="checkbox"
                  />
                </Tooltip>
              ...
              <button type="submit" className={styles.send} onClick={handleSubmit}>
                регистрация
              </button>
            </div>
          </form>
    ...
    return (
        <div className={styles.register}>
          ...
          <div className={styles.registerSuccesWrapper}>
            ...
            <Link href="/">
              <a>
                <div className={styles.registerSuccesBtn}>Перейти на главную</div>
              </a>
            </Link>
          </div>
          <Basket />
