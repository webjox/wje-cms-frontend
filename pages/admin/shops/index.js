...
export default function Shops() {
    ...
    return (
        <div>
            ...
            pageName={"Магазины"}
            />
            <div><ShopsList shopsData={shops} /> </div>
            <div onClick={e => addShop(setShops)} style={{display: 'flex', justifyContent: 'center', cursor: 'pointer', marginTop: 10}}><AddCircle color='primary' style={{fontSize: 48}} /></div>
        </div>
    )
}