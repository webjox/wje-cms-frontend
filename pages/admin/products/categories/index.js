...
export default function ProductCategories() {
    ...
    return (
        ...
        <div style={{display: 'flex', justifyContent: 'center'}}><ProductCategoriesList categoryData={categoriesData} /></div>
        <div onClick={e => addCategory(setCategoriesData)} style={{display: 'flex', justifyContent: 'center', cursor: 'pointer'}}><AddCircleIcon color='primary' style={{fontSize: 48}} /></div>
