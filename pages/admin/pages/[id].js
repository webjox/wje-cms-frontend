    ...
    return (
        <div>
            ...
            <form className={`container ${formStyles.formContainer}`}>
                ...
                <TextField className={formStyles.formInput} id="meta_title" label="Meta title" defaultValue={page.meta_title} onChange={event => {handleChange(event, 'meta_title')}} />
                <TextField className={formStyles.formInput} id="meta_description" label="Meta description" defaultValue={page.meta_description} onChange={event => {handleChange(event, 'meta_description')}} />
                <TextField className={formStyles.formInput} id="slug" label="slug" defaultValue={page.slug} onChange={event => {handleChange(event, 'slug')}} />
                <TextField className={formStyles.formInput} id="card_name" label="Card name" defaultValue={page.card_name} onChange={event => {handleChange(event, 'card_name')}} />
                <FormControlLabel
                ...
                <div className={formStyles.formButtonContainer}>
                    <Button onClick={e => updatePage(id, page)} variant="contained" color="primary">Сохранить</Button>
                </div>

                <br />
                <span>Загруженные изображения: </span>
                <div style={{display: 'flex', flexWrap: 'wrap'}}>
                    {page.card_image ? <ImageCard image={page.card_image} removeAction={removeImageHandler} updateAlt={updateImageHandler}/> : null}
                </div>
                <DropzoneArea
                ...
                />
                <div className={formStyles.formButtonContainer}>
                    <Button onClick={e => uploadImage(id, imageData, setPage)} variant="contained" color="primary">Загрузить изображение</Button>
                </div>
            </form>
            ...
            <Button onClick={e => {
                ...
                }} className={formStyles.DeleteButton} variant="contained" color="secondary">Удалить страницу</Button>
            </div> : null}
            </div> 
            : 
            <div>
