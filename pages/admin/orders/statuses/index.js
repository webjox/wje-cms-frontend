...
export default function ProductCategories() {
    ...
    return (
        <div>
        <Header 
            pageName={`Список статусов`} 
            backButton={true}
        />

        <div style={{display: 'flex', justifyContent: 'center'}}><StatusesList statusesData={statuses} /></div>
        <div onClick={e => {addStatus()}} style={{display: 'flex', justifyContent: 'center', cursor: 'pointer'}}><AddCircleIcon color='primary' style={{fontSize: 48}} /></div>
